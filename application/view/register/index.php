<main>
    ...
    <div class="login-box" style="width: 50%; display: block;">
        ...
        <form method="post" action="<?php echo Config::get('URL'); ?>register/register_action">
            ...
            <input type="text" name="user_email_repeat" placeholder="repeat email address (to prevent typos)" required /><br>
            ...
            <input type="text" name="captcha" placeholder="Please enter above characters" required /><br>

            <!-- quick & dirty captcha reloader -->
            <a href="#" style="display: block; font-size: 11px; margin: 5px 0 15px 0; text-align: center" onclick="document.getElementById('captcha').src = '<?php echo Config::get('URL'); ?>register/showCaptcha?' + Math.random(); return false">Reload Captcha</a>
