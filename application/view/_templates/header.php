    ...
    <body id="body" >
        <header>
            ...
            <ul class="nav-left" >
                ...
                <li><a href="<?php echo Config::get('URL'); ?>color/index" >
            ...
            <ul class="nav-right" >
                <?php if (Session::userIsLoggedIn()) { ?>
                    <p hidden="true" class="nav-right-p" >Click here for your Profile »</p>
                    <li><a href="<?php echo Config::get('URL'); ?>my-profile/index" >
                        <button id="nav-button-right-image" class="nav-button-right nav-button-right-image" ></button>
                    </a></li>
                    <li><a href="<?php echo Config::get('URL'); ?>login/logout" >
